...
**Video stream**: Long-running loop

- Input: Sequence of Images
- Output: events, visuals, or actions

## Realtime Inference

**Realtime** means the system processes input and reacts fast enough that the user experiences it as happening now (a live camera feed feels interactive. A delayed batch job does not).
...
:::: {.columns}
::: {.column width="65%"}
![](../assets/inference_appliance.svg){fig-align="center" width=100%}
:::
::: {.column width="35%"}
**Common actions:**
