...
The **Model** is the core engine of the _agent_ allowing it to reason & respond.
...
See: [Coding Leaderboard on LM Arena](https://arena.ai/leaderboard/code/webdev)
