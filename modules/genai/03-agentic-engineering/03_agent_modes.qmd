...
An agent is built on three basic components (M.I.T):

::: {.incremental}
1. **Model**: The agent model you pick for the task (LLM)
2. **Instructions**:
...
1. Ask
2. Plan (spend most of your time here)
3. Agent (general)
4. Debug
5. Multitask
...
Suggested by [Boris Cherny from Anthropic](https://www.youtube.com/live/6eBSHbLKuN0?si=44v_2r_gq9uNeKQf&t=253) (creator of Claude Code)
