...
2. Transfer Learning
3. PyTorch Techniques and Model Inspection
4. Building a CNN for Nature Classification
5. Model Debugging, Inspection, and Modularization
6. Programming Assignment: Overcoming Overfitting
...
In [Session 2: PyTorch Techniques and Model Inspection](../ch3_techniques/session2.qmd) we learn:
